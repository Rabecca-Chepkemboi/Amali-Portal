...
const Dashboard = () => {
  ...
  return (
  <Layout>
    <div className="flex w-[1500px] h-[100vh] fixed bg-white">
      <div className="flex-1 p-4 mt-12">
        ...
        <div className="flex gap-32 cursor-pointer ml-[156px] mt-4">
    ...
    <div className='mt-64 font-bold ml-48 text-4xl text-black fixed font-merriweather'> <p>Sponsorship Statistics</p></div>
    <div className="ml-32 mt-[320px] fixed">
      <LineChart width={1310} height={650} data={chartData}>
        <XAxis dataKey="name">
